...
use crate::interface::protocol_handler::{Command, parse_command};
use std::sync::Arc;
...
impl ConnectionHandler {
    ...
    /// On extrait les Arc avant le split() pour éviter les conflits borrow checker.
